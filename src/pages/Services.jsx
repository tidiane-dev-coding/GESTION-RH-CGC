                        ...
                        <div className="overflow-x-auto">
                          ...
                          <thead className="bg-gray-50">
                            <tr>
                              ...
                              <th className="px-4 py-2 text-left text-[11px] font-semibold text-gray-700 uppercase tracking-wider">Nom</th>
                              ...
                              <th className="px-4 py-2 text-left text-[11px] font-semibold text-gray-700 uppercase tracking-wider">CADRE/S/M</th>
                          ...
                          <tbody className="bg-white divide-y divide-gray-200">
                            {serviceEmployees.map((employee) => (
                              <tr key={employee._id} className="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td className="px-4 py-2 text-xs text-gray-800">{employee.nom}</td>
                      ...
                      <div className="grid grid-cols-1 gap-4 md:hidden">
                        {serviceEmployees.map((employee) => (
                          ...
                          >
                            ...
                            <p className="text-sm font-medium text-gray-900">{employee.nom}</p>
                            ...
                            <div className="grid grid-cols-2 gap-2 text-[11px] text-gray-700">
                              ...
                              <div>
                                <p className="text-gray-500 text-[10px]">CADRE/S/M</p>
                                <p>{employee.cadre || '-'}</p>
                              </div>
                              <div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl p-8">
            ...
            <form onSubmit={async (e) => {
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">CADRE/S/M</label>
