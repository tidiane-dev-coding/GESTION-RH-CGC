        ...
        <div className="overflow-x-auto">
          ...
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 sm:px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">CADRE/S/M</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {employees.map((emp, index) => (
              <tr key={emp._id} className="hover:bg-gray-50 transition-colors duration-200">
                ...
                <td className="px-4 sm:px-6 py-4 text-sm text-gray-700">{emp.nom}</td>
      ...
      <div className="space-y-4 md:hidden mt-4">
        {employees.map((emp) => (
          ...
          >
            ...
            <p className="text-sm font-medium text-gray-900">{emp.nom}</p>
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-white mb-2">CADRE/S/M</label>
